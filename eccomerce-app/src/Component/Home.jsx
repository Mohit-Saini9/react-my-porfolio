...
const Home = () => {
  ...
  return (
    <div name='home'  className="max-h-screen   md:max-h-screen w-full text-black">
      <div
      ...
      >
        <div className="px-3 mx-auto">
          ...
          <Link to={'home'} smooth duration={400}>  Hi I am Mohit Saini</Link>
          </h2>  
          ...
          <button className="bg-cyan-400 rounded-lg  px-6 py-3 
          hover:scale-110 duration-300 " onClick={()=>alert('dowload cv')}>DownloadCv</button>
          <button className="bg-cyan-400 rounded-lg px-6 py-3 ml-20
        ...
        <div className="flex justify-between p-2 text-l font-medium  md:hidden">
          <button className="bg-cyan-400 rounded-lg  px-6 py-3 
          hover:scale-110 duration-300  ">DownloadCv</button>
          <button className="bg-cyan-400 rounded-lg px-6 py-3
